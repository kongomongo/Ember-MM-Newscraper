...
#Region "Fields"
    ...
    Public HostList As New List(Of Host)
...
#Region "Methods"
    ...
    Private Sub RemoveKodiHost()
        If lbHosts.SelectedItems.Count > 0 Then
            Dim HostToRemove As Host = HostList.FirstOrDefault(Function(f) f.Label = lbHosts.SelectedItem.ToString)
    ...
    Private Sub btnEditHost_Click(sender As Object, e As EventArgs) Handles btnEditHost.Click, lbHosts.DoubleClick
        If lbHosts.SelectedItems.Count > 0 Then
            Dim oldHost As Host = HostList.FirstOrDefault(Function(f) f.Label = lbHosts.SelectedItem.ToString)
