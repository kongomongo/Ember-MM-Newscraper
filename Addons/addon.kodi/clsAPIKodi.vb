...
#Region "Methods"
        ...
        ''' </remarks>
        Public Shared Function GetHostJSONVersion(ByVal kHost As Host) As String
            Try
        ...
        Private Async Function SearchTVEpisode(ByVal tDBElement As Database.DBElement) As Task(Of Video.Details.Episode)
            ...
            If Not String.IsNullOrEmpty(strRemotePath) Then
                Try
                    ...
                    kTVEpisodes = Await _kodi.VideoLibrary.GetEpisodes(filter, ShowID, tDBElement.MainDetails.Season, Video.Fields.Episode.AllFields).ConfigureAwait(False)
                Catch ex As Exception
                    logger.Error(ex, New StackFrame().GetMethod().Name)
                    Return Nothing
                End Try
        ...
        Private Async Function SearchTVSeason(ByVal tDBElement As Database.DBElement) As Task(Of Video.Details.Season)
            ...
            If kTVSeasons IsNot Nothing Then
                If kTVSeasons.seasons IsNot Nothing Then
                    Dim result = kTVSeasons.seasons.FirstOrDefault(Function(f) f.season = If(tDBElement.MainDetails.Season = 999, -1, tDBElement.MainDetails.Season))
        ...
        Public Async Function UpdateInfo_Movie(ByVal mDBElement As Database.DBElement, ByVal blnSendHostNotification As Boolean, ByVal GenericSubEvent As IProgress(Of GenericSubEventCallBackAsync), ByVal GenericMainEvent As IProgress(Of GenericEventCallBackAsync)) As Task(Of Boolean)
            ...
            Try
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    Dim mImdbnumber As String = mDBElement.MainDetails.IMDB
                    ...
                    Dim mSet As String = If(mDBElement.MainDetails.SetsSpecified, mDBElement.MainDetails.Sets.Item(0).Title, String.Empty)
                    ...
                    'ShowLinks
                    Dim mShowLinkList As List(Of String) = If(mDBElement.MainDetails.ShowLinksSpecified, mDBElement.MainDetails.ShowLinks, New List(Of String))
        ...
        Public Async Function UpdateInfo_TVShow(ByVal mDBElement As Database.DBElement, ByVal blnSendHostNotification As Boolean, ByVal GenericSubEvent As IProgress(Of GenericSubEventCallBackAsync), ByVal GenericMainEvent As IProgress(Of GenericEventCallBackAsync)) As Task(Of Boolean)
            ...
            Try
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    'string or string.empty
                    Dim mEpisodeGuide As String = mDBElement.MainDetails.EpisodeGuide.URL
                    Dim mImdbnumber As String = If(mDBElement.MainDetails.TVDBSpecified, CStr(mDBElement.MainDetails.TVDB), String.Empty)
                    Dim mMPAA As String = mDBElement.MainDetails.MPAA
                    Dim mOriginalTitle As String = mDBElement.MainDetails.OriginalTitle
                    Dim mPlot As String = mDBElement.MainDetails.Plot
