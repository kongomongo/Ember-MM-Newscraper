...
#Region "Fields"
    ...
    Private _shortname As String = "HD-Trailers.net"
...
#Region "Methods"
    ...
    Public Function Run(ByRef tDBElement As Database.DBElement, ByVal eAddonEventType As Enums.AddonEventType, ByVal lstParams As List(Of Object)) As Interfaces.AddonResult Implements Interfaces.Addon.Run
        logger.Trace("[HDTrailers] [Run] [Start]")
        ...
        Select Case eAddonEventType
            Case Enums.AddonEventType.Scrape_Movie
                ...
                nModuleResult = _scraper.Scrape_Movie(tDBElement.MainDetails.OriginalTitle, tDBElement.MainDetails.Title, tDBElement.MainDetails.IMDB, tDBElement.ScrapeModifiers, tDBElement.ScrapeOptions)
        End Select

        logger.Trace("[HDTrailers] [Run] [Done]")
