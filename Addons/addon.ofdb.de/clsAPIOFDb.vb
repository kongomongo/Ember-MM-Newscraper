...
#Region "Methods"
    ...
    Public Function GetInfo_Movie(ByVal strIMDBID As String, ByVal tScrapeModifiers As Structures.ScrapeModifiers, ByVal tScrapeOptions As Structures.ScrapeOptions) As Interfaces.AddonResult
        Try
            ...
            If Not String.IsNullOrEmpty(sURL) Then
                ...
                If Not String.IsNullOrEmpty(HTML) Then
                    ...
                    'Outline
                    If tScrapeOptions.bMainOutline Then
                    ...
                    End If
                    nAddonResult.ScraperResult_Data = nMovie
                End If
            End If
    ...
    Private Function SearchMovie(ByVal strIMDBID As String) As String
        ...
        Try
            ...
            End If
        Catch ex As Exception
            logger.Error(ex, New StackFrame().GetMethod().Name & "Error scraping ODFB (too many connections?):" & strIMDBID)
        End Try
