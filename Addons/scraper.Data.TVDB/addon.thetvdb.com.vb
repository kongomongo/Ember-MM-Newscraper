            ...
            Case Enums.AddonEventType.Scrape_TVEpisode
                If tDBElement.TVShowDetails.TVDBSpecified Then
                    If tDBElement.MainDetails.SeasonSpecified AndAlso tDBElement.MainDetails.EpisodeSpecified Then
                        nModuleResult.ScraperResult_Data = _scraper.GetInfo_TVEpisode(tDBElement.TVShowDetails.TVDB, tDBElement.MainDetails.Season, tDBElement.MainDetails.Episode, tDBElement.Ordering, tDBElement.ScrapeModifiers, tDBElement.ScrapeOptions)
                    ElseIf tDBElement.MainDetails.AiredSpecified Then
                        nModuleResult.ScraperResult_Data = _scraper.GetInfo_TVEpisode(tDBElement.TVShowDetails.TVDB, tDBElement.MainDetails.Aired, tDBElement.ScrapeModifiers, tDBElement.ScrapeOptions)
                    Else
                        logger.Trace("[TVDB] [Run] [Abort] No Season- Episodenumber and also no AiredDate available")
                    End If
                Else
