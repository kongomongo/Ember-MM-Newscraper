...
Public Class ThemeLibrary_Theme
...
#Region "Fields"
    ...
    Private _Name As String = "ThemeLibrary_Theme"
...
#Region "Methods"
    ...
    Function InjectSetupScraper_Movie() As Containers.SettingsPanel Implements Interfaces.ScraperModule_Theme_Movie.InjectSetupScraper
        ...
        SPanel.Text = "ThemeLibrary"
        SPanel.Prefix = "ThemeLibraryMovieThemes_"
        SPanel.Order = 110
    ...
    Function InjectSetupScraper_TV() As Containers.SettingsPanel Implements Interfaces.ScraperModule_Theme_TV.InjectSetupScraper
        ...
        SPanel.Text = "ThemeLibrary"
        SPanel.Prefix = "ThemeLibraryTVThemes_"
        SPanel.Order = 110
    ...
    Function Scraper_Movie(ByRef DBMovie As Database.DBElement, ByVal Type As Enums.ScrapeModifierType, ByRef ThemeList As List(Of MediaContainers.Theme)) As Interfaces.ModuleResult_old Implements Interfaces.ScraperModule_Theme_Movie.Scraper
        ...
        If tScraper.ThemeList.Count > 0 Then
            ThemeList = tScraper.ThemeList
        End If
