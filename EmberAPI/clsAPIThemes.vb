...
#Region "Methods"
    ...
    Public Shared Sub Delete(ByVal strPath As String)
    ...
    ''' <param name="tDBElement"><c>DBMovie</c> structure representing the movie on which we should operate</param>
    ''' <remarks></remarks>
    Public Shared Sub Delete_TVShow(ByVal tDBElement As Database.DBElement) ', ByVal ForceFileCleanup As Boolean)
    ...
    Public Function Save_Movie(ByVal tDBElement As Database.DBElement) As String
        ...
        Try
            Try
                ...
                'AddonsManager.Instance.RunGeneric(Enums.AddonEventType.OnThemeSave_Movie, params, False)
            Catch ex As Exception
                logger.Error(ex, New StackFrame().GetMethod().Name)
            End Try

            For Each a In FileUtils.GetFilenameList.Movie(tDBElement, Enums.ScrapeModifierType.MainTheme)
