...
#Region "Methods"
    ...
    Public Shared Function GetPreferredMovieTrailer(ByRef TrailerList As List(Of MediaContainers.Trailer), ByRef trlResult As MediaContainers.Trailer) As Boolean
        ...
        If Master.eSettings.Movie.TrailerSettings.PrefVideoQuality = Enums.TrailerVideoQuality.Any Then
        ...
        If trlResult Is Nothing Then
            For Each nTrailer As MediaContainers.Trailer In TrailerList
                If YouTube.UrlUtils.IsYouTubeURL(nTrailer.URLWebsite) Then
                    ...
                    ytTrailer = sYouTube.YouTubeLinks.VideoLinks.Find(Function(f) f.FormatQuality = Master.eSettings.Movie.TrailerSettings.PrefVideoQuality)
                ...
                ElseIf Regex.IsMatch(nTrailer.URLWebsite, "https?:\/\/.*imdb.*") Then
                    ...
                    'try to get preferred quality
                    If sIMDb.VideoLinks.ContainsKey(Master.eSettings.Movie.TrailerSettings.PrefVideoQuality) Then
                        nTrailer.URLVideoStream = sIMDb.VideoLinks(Master.eSettings.Movie.TrailerSettings.PrefVideoQuality).URL
                        nTrailer.Quality = Master.eSettings.Movie.TrailerSettings.PrefVideoQuality
                    Else
                        If sIMDb.VideoLinks.ContainsKey(Enums.TrailerVideoQuality.HD2160p60fps) Then
                ...
                If nTrailer.Quality = Master.eSettings.Movie.TrailerSettings.PrefVideoQuality Then
                    trlResult = nTrailer
                    Exit For
                End If
            Next
        ...
        If trlResult Is Nothing Then
            Select Case Master.eSettings.Movie.TrailerSettings.MinVideoQuality
