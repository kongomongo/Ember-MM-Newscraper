            ...
            Select Case _ContentType
                Case Enums.ContentType.Movie
                    ...
                    With Master.eSettings.Movie.Filenaming
                        ...
                        mMainActorThumbsAllowed = .FilenameAnyEnabled_Actorthumbs
                        mMainBannerAllowed = .FilenameAnyEnabled_Banner AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainBanner)
                        mMainCharacterArtAllowed = False
                        mMainClearArtAllowed = .FilenameAnyEnabled_ClearArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainClearArt)
                        mMainClearLogoAllowed = .FilenameAnyEnabled_ClearLogo AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainClearLogo)
                        mMainDiscArtAllowed = .FilenameAnyEnabled_DiscArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainDiscArt)
                        mMainExtrafanartsAllowed = .FilenameAnyEnabled_Extrafanarts AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainFanart)
                        mMainExtrathumbsAllowed = .FilenameAnyEnabled_Extrathumbs AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainFanart)
                        mMainFanartAllowed = .FilenameAnyEnabled_Fanart AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainFanart)
                        mMainLandscapeAllowed = .FilenameAnyEnabled_Landscape AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainLandscape)
                        mMainMetaDataAllowed = Master.eSettings.Movie.DataSettings.MetaDataScan
                        mMainNFOAllowed = .FilenameAnyEnabled_NFO
                        mMainPosterAllowed = .FilenameAnyEnabled_Poster AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ScrapeModifierType.MainPoster)
                        mMainThemeAllowed = .FilenameAnyEnabled_Theme AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Theme_Movie(Enums.ScrapeModifierType.MainTheme)
                        mMainTrailerAllowed = .FilenameAnyEnabled_Trailer AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Trailer_Movie(Enums.ScrapeModifierType.MainTrailer)
                    ...
                    With Master.eSettings.Movie.DataSettings
                        ...
                        oMainCollectionIDAllowed = .CollectionID.Enabled
                        ...
                        oMainRatingAllowed = .Rating.Enabled
                        oMainReleaseDateAllowed = .ReleaseDate.Enabled
                        ...
                        oMainTrailerAllowed = .Trailer.Enabled
                        oMainUserRatingAllowed = .UserRating.Enabled
                        oMainWritersAllowed = .Credits.Enabled
                        oMainYearAllowed = .Year.Enabled
                ...
                Case Enums.ContentType.Movieset
                    ...
                    With Master.eSettings.Movieset.Filenaming
                        ...
                        mMainBannerAllowed = .FilenameAnyEnabled_Banner AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainBanner)
                        mMainCharacterArtAllowed = False
                        mMainClearArtAllowed = .FilenameAnyEnabled_ClearArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainClearArt)
                        mMainClearLogoAllowed = .FilenameAnyEnabled_ClearLogo AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainClearLogo)
                        mMainDiscArtAllowed = .FilenameAnyEnabled_DiscArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainDiscArt)
                        mMainExtrafanartsAllowed = False
                        mMainExtrathumbsAllowed = False
                        mMainFanartAllowed = .FilenameAnyEnabled_Fanart AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainFanart)
                        mMainLandscapeAllowed = .FilenameAnyEnabled_Landscape AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainLandscape)
                        mMainMetaDataAllowed = False
                        mMainNFOAllowed = .FilenameAnyEnabled_NFO
                        mMainPosterAllowed = .FilenameAnyEnabled_Poster AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ScrapeModifierType.MainPoster)
                ...
                Case Enums.ContentType.TV
                    ...
                    With Master.eSettings.TV.Filenaming.TVEpisode
                        mEpisodeActorThumbsAllowed = .FilenameAnyEnabled_Actorthumbs
                        mEpisodeFanartAllowed = .FilenameAnyEnabled_Fanart AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.EpisodeFanart)
                        mEpisodeMetaDataAllowed = Master.eSettings.TV.DataSettings.MetaDataScan
                        mEpisodeNFOAllowed = .FilenameAnyEnabled_NFO
                        mEpisodePosterAllowed = .FilenameAnyEnabled_Poster AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.EpisodePoster)
                    End With
                    With Master.eSettings.TV.Filenaming.TVShow
                        mMainActorThumbsAllowed = .FilenameAnyEnabled_Actorthumbs
                        mMainBannerAllowed = .FilenameAnyEnabled_Banner AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainBanner)
                        mMainCharacterArtAllowed = .FilenameAnyEnabled_CharacterArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainCharacterArt)
                        mMainClearArtAllowed = .FilenameAnyEnabled_ClearArt AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainClearArt)
                        mMainClearLogoAllowed = .FilenameAnyEnabled_ClearLogo AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainClearLogo)
                        mMainDiscArtAllowed = False
                        mMainExtrafanartsAllowed = .FilenameAnyEnabled_Extrafanarts AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainFanart)
                        mMainExtrathumbsAllowed = False
                        mMainFanartAllowed = .FilenameAnyEnabled_Fanart AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainFanart)
                        mMainLandscapeAllowed = .FilenameAnyEnabled_Landscape AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainLandscape)
                        mMainMetaDataAllowed = False
                        mMainNFOAllowed = .FilenameAnyEnabled_NFO
                        mMainPosterAllowed = .FilenameAnyEnabled_Poster AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainPoster)
                        mMainThemeAllowed = .FilenameAnyEnabled_Theme AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Theme_TV(Enums.ScrapeModifierType.MainTheme)
                        mMainTrailerAllowed = False
                    End With
                    With Master.eSettings.TV.Filenaming.TVSeason
                        mSeasonBannerAllowed = .FilenameAnyEnabled_Banner AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonBanner)
                        mSeasonFanartAllowed = .FilenameAnyEnabled_Fanart AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonFanart)
                        mSeasonLandscapeAllowed = .FilenameAnyEnabled_Landscape AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonLandscape)
                        mSeasonPosterAllowed = .FilenameAnyEnabled_Poster AndAlso AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonPoster)
                    End With
                    With Master.eSettings.TV.DataSettings.TVEpisode
                        ...
                        oEpisodeRatingAllowed = .Rating.Enabled
                        oEpisodeRuntimeAllowed = .Runtime.Enabled
                        oEpisodeTitleAllowed = .Title.Enabled
                        oEpisodeUserRatingAllowed = .UserRating.Enabled
