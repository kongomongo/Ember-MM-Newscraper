        ...
        With Master.eSettings
            Select Case _ContentType
                Case Enums.ContentType.Movie
                    ...
                    mMainBannerAllowed = .FilenameAnyEnabled_Movie_Banner AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainBanner)
                    mMainCharacterArtAllowed = False
                    mMainClearArtAllowed = .FilenameAnyEnabled_Movie_ClearArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainClearArt)
                    mMainClearLogoAllowed = .FilenameAnyEnabled_Movie_ClearLogo AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainClearLogo)
                    mMainDiscArtAllowed = .FilenameAnyEnabled_Movie_DiscArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainDiscArt)
                    mMainExtrafanartsAllowed = .FilenameAnyEnabled_Movie_Extrafanarts AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainFanart)
                    mMainExtrathumbsAllowed = .FilenameAnyEnabled_Movie_Extrathumbs AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainFanart)
                    mMainFanartAllowed = .FilenameAnyEnabled_Movie_Fanart AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainFanart)
                    mMainLandscapeAllowed = .FilenameAnyEnabled_Movie_Landscape AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainLandscape)
                    mMainMetaDataAllowed = .MovieScraperMetaDataScan
                    mMainNFOAllowed = .FilenameAnyEnabled_Movie_NFO
                    mMainPosterAllowed = .FilenameAnyEnabled_Movie_Poster AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_Movie(Enums.ModifierType.MainPoster)
                    mMainThemeAllowed = .FilenameAnyEnabled_Movie_Theme AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Theme_Movie(Enums.ModifierType.MainTheme)
                    mMainTrailerAllowed = .FilenameAnyEnabled_Movie_Trailer AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Trailer_Movie(Enums.ModifierType.MainTrailer)
                ...
                Case Enums.ContentType.MovieSet
                    ...
                    mMainBannerAllowed = .FilenameAnyEnabled_MovieSet_Banner AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainBanner)
                    mMainCharacterArtAllowed = False
                    mMainClearArtAllowed = .FilenameAnyEnabled_MovieSet_ClearArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainClearArt)
                    mMainClearLogoAllowed = .FilenameAnyEnabled_MovieSet_ClearLogo AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainClearLogo)
                    mMainDiscArtAllowed = .FilenameAnyEnabled_MovieSet_DiscArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainDiscArt)
                    mMainExtrafanartsAllowed = False
                    mMainExtrathumbsAllowed = False
                    mMainFanartAllowed = .FilenameAnyEnabled_MovieSet_Fanart AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainFanart)
                    mMainLandscapeAllowed = .FilenameAnyEnabled_MovieSet_Landscape AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainLandscape)
                    mMainMetaDataAllowed = False
                    mMainNFOAllowed = .FilenameAnyEnabled_MovieSet_NFO
                    mMainPosterAllowed = .FilenameAnyEnabled_MovieSet_Poster AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_MovieSet(Enums.ModifierType.MainPoster)
                ...
                Case Enums.ContentType.TV
                    ...
                    mEpisodeFanartAllowed = .FilenameAnyEnabled_TVEpisode_Fanart AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.EpisodeFanart)
                    mEpisodeMetaDataAllowed = .TVScraperMetaDataScan
                    mEpisodeNFOAllowed = .FilenameAnyEnabled_TVEpisode_NFO
                    mEpisodePosterAllowed = .FilenameAnyEnabled_TVEpisode_Poster AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.EpisodePoster)
                    mMainActorThumbsAllowed = .FilenameAnyEnabled_TVShow_ActorTumbs
                    mMainBannerAllowed = .FilenameAnyEnabled_TVShow_Banner AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainBanner)
                    mMainCharacterArtAllowed = .FilenameAnyEnabled_TVShow_CharacterArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainCharacterArt)
                    mMainClearArtAllowed = .FilenameAnyEnabled_TVShow_ClearArt AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainClearArt)
                    mMainClearLogoAllowed = .FilenameAnyEnabled_TVShow_ClearLogo AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainClearLogo)
                    mMainDiscArtAllowed = False
                    mMainExtrafanartsAllowed = .FilenameAnyEnabled_TVShow_Extrafanarts AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainFanart)
                    mMainExtrathumbsAllowed = False
                    mMainFanartAllowed = .FilenameAnyEnabled_TVShow_Fanart AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainFanart)
                    mMainLandscapeAllowed = .FilenameAnyEnabled_TVShow_Landscape AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainLandscape)
                    mMainMetaDataAllowed = False
                    mMainNFOAllowed = .FilenameAnyEnabled_TVShow_NFO
                    mMainPosterAllowed = .FilenameAnyEnabled_TVShow_Poster AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.MainPoster)
                    mMainThemeAllowed = .FilenameAnyEnabled_TVShow_Theme AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Theme_TV(Enums.ModifierType.MainTheme)
                    mMainTrailerAllowed = False
                    mSeasonBannerAllowed = .FilenameAnyEnabled_TVSeason_Banner AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.SeasonBanner)
                    mSeasonFanartAllowed = . FilenameAnyEnabled_TVSeason_Fanart AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.SeasonFanart)
                    mSeasonLandscapeAllowed = .FilenameAnyEnabled_TVSeason_Landscape AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.SeasonLandscape)
                    mSeasonPosterAllowed = .FilenameAnyEnabled_TVSeason_Poster AndAlso ModulesManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ModifierType.SeasonPoster)
