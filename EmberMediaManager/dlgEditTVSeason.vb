    ...
    Private Sub FillInfo()
        ...
        With tmpDBElement.ImagesContainer
            ...
            If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Master.eSettings.FilenameAnyEnabled_TVSeason_Banner) OrElse
                ...
                If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonBanner)) OrElse
                    (tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonBanner) AndAlso
                     Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainBanner)) Then
            ...
            If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Master.eSettings. FilenameAnyEnabled_TVSeason_Fanart) OrElse
                ...
                If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonFanart) AndAlso
                    Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainFanart)) OrElse
                    (tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonFanart) AndAlso
                     Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainFanart)) Then
            ...
            If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Master.eSettings.FilenameAnyEnabled_TVSeason_Landscape) OrElse
                ...
                If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonLandscape)) OrElse
                    (tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonLandscape) AndAlso
                     Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainLandscape)) Then
            ...
            If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Master.eSettings.FilenameAnyEnabled_TVSeason_Poster) OrElse
                ...
                If (Not tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonPoster)) OrElse
                    (tmpDBElement.MainDetails.Season = 999 AndAlso Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.SeasonPoster) AndAlso
                     Not AddonsManager.Instance.ScraperWithCapabilityAnyEnabled_Image_TV(Enums.ScrapeModifierType.MainPoster)) Then
