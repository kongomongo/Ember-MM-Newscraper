...
Partial Class frmOption_Proxy
    ...
    Private Sub InitializeComponent()
        ...
        Me.pnlSettings.Size = New System.Drawing.Size(476, 396)
        ...
        Me.tblSettings.RowStyles.Add(New System.Windows.Forms.RowStyle())
        Me.tblSettings.Size = New System.Drawing.Size(476, 396)
    ...
    Friend WithEvents gbProxyOpts As Windows.Forms.GroupBox
    Friend WithEvents tblProxyOpts As Windows.Forms.TableLayoutPanel
    Friend WithEvents gbProxyCredsOpts As Windows.Forms.GroupBox
    Friend WithEvents tblProxyCredsOpts As Windows.Forms.TableLayoutPanel
    Friend WithEvents txtProxyDomain As Windows.Forms.TextBox
    Friend WithEvents chkProxyCredsEnable As Windows.Forms.CheckBox
    Friend WithEvents lblProxyDomain As Windows.Forms.Label
    Friend WithEvents lblProxyUsername As Windows.Forms.Label
    Friend WithEvents txtProxyPassword As Windows.Forms.TextBox
    Friend WithEvents txtProxyUsername As Windows.Forms.TextBox
    Friend WithEvents lblProxyPassword As Windows.Forms.Label
    Friend WithEvents chkProxyEnable As Windows.Forms.CheckBox
    Friend WithEvents txtProxyPort As Windows.Forms.TextBox
    Friend WithEvents lblProxyPort As Windows.Forms.Label
    Friend WithEvents lblProxyURI As Windows.Forms.Label
    Friend WithEvents txtProxyURI As Windows.Forms.TextBox
End Class
